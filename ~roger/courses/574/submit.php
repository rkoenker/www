...
It should have a filename that is of the form: name.pdf, where name 
is your name in lower case letters.
...
There should be no more than 8 distinct slides, with no fancy pausing, or  movie insertions

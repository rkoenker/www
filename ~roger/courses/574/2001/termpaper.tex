...
Spring 2001 \hfill Roger Koenker
...
Noon, May 4.  The paper may take one of three forms:
...
\item an empirical note which explores the application of a technique we have considered on a ``real'' data set.
...
March 9.  This is the last day of class before spring break.
These proposals should contain at least three relevant references to 

# Make tables for sim1 this is really ugly should have restructured the sim1 output.
require(quantreg)
...
cap <- "Root Mean Squared Error in 1000 Replications: Bennett Model"
lab <- "sim1"
latex.table(tab, file = "sim1", rowlabel = "", dec = 3,

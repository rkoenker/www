...
adpoted based on the \code{Sweave} tools. The SVN archive, containing the
...
log(POPGRO/100 + 0.05)  -0.3794     0.4676   -0.81   0.4224   
...
showing that neither have power against orthogonal shifts. Here, we
...
\proglang{R}~2.6.0---with the packages
\pkg{lmtest}~0.9--21, \pkg{sandwich}~2.0--2,
\pkg{MASS}~7.2--36, \pkg{strucchange}~1.3--2,
and \pkg{lattice}~0.16--5---and

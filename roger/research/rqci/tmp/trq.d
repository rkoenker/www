...
of rows of x should equal the number of elemants of  y,  and
...
.AG int
flag for intercept; if TRUE, an intercept term is included in regrssion model. 
The default includes an intercept term.
.AG z
structure returned by the function 'rq' with t <0 or >1. If missing, the function rq(x,y,int=int) is automatically called to generate this argument.
...
.KW regression quantiles, robust regression, trimmed mean
.SH METHOD
